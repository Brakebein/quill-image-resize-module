...
var apply = __webpack_require__(6874),
    ...
    customDefaultsMerge = __webpack_require__(2052),
...
;// CONCATENATED MODULE: ./src/modules/BaseModule.js
class BaseModule {
  constructor(resizer) {
...
;// CONCATENATED MODULE: ./src/modules/DisplaySize.js

class DisplaySize extends BaseModule {
  onCreate = () => {
    // Create the container to hold the size display
    this.display = document.createElement('div'); // Apply styles

    Object.assign(this.display.style, this.options.displayStyles); // Attach it
...
;// CONCATENATED MODULE: ./node_modules/quill/assets/icons/align-left.svg
/* harmony default export */ const align_left = ("<svg viewbox=\"0 0 18 18\">\n  <line class=\"ql-stroke\" x1=\"3\" x2=\"15\" y1=\"9\" y2=\"9\"></line>\n  <line class=\"ql-stroke\" x1=\"3\" x2=\"13\" y1=\"14\" y2=\"14\"></line>\n  <line class=\"ql-stroke\" x1=\"3\" x2=\"9\" y1=\"4\" y2=\"4\"></line>\n</svg>");
;// CONCATENATED MODULE: ./node_modules/quill/assets/icons/align-center.svg
/* harmony default export */ const align_center = ("<svg viewbox=\"0 0 18 18\">\n  <line class=\"ql-stroke\" x1=\"15\" x2=\"3\" y1=\"9\" y2=\"9\"></line>\n  <line class=\"ql-stroke\" x1=\"14\" x2=\"4\" y1=\"14\" y2=\"14\"></line>\n  <line class=\"ql-stroke\" x1=\"12\" x2=\"6\" y1=\"4\" y2=\"4\"></line>\n</svg>");
;// CONCATENATED MODULE: ./node_modules/quill/assets/icons/align-right.svg
/* harmony default export */ const align_right = ("<svg viewbox=\"0 0 18 18\">\n  <line class=\"ql-stroke\" x1=\"15\" x2=\"3\" y1=\"9\" y2=\"9\"></line>\n  <line class=\"ql-stroke\" x1=\"15\" x2=\"5\" y1=\"14\" y2=\"14\"></line>\n  <line class=\"ql-stroke\" x1=\"15\" x2=\"9\" y1=\"4\" y2=\"4\"></line>\n</svg>");
;// CONCATENATED MODULE: ./node_modules/quill/assets/icons/undo.svg
/* harmony default export */ const undo = ("<svg viewbox=\"0 0 18 18\">\n  <polygon class=\"ql-fill ql-stroke\" points=\"6 10 4 12 2 10 6 10\"></polygon>\n  <path class=\"ql-stroke\" d=\"M8.09,13.91A4.6,4.6,0,0,0,9,14,5,5,0,1,0,4,9\"></path>\n</svg>");
;// CONCATENATED MODULE: ./src/modules/Toolbar.js
...
const Parchment = (quill_default()).imports.parchment;
...
quill_default().register(offsetAttributor);
class Toolbar extends BaseModule {
  onCreate = () => {
    // Setup Toolbar
    this.toolbar = document.createElement('div');
    Object.assign(this.toolbar.style, this.options.toolbarStyles);
    this.overlay.appendChild(this.toolbar); // Setup Buttons
  ...
  onDestroy = () => {}; // Nothing to update on drag because we are are positioned relative to the overlay
...
;// CONCATENATED MODULE: ./src/modules/Resize.js

class Resize extends BaseModule {
  onCreate = () => {
    // track resize handles
    this.boxes = []; // add 4 resize handles
  ...
  positionBoxes = () => {
    ...
    const handleYOffset = `${-parseFloat(this.options.handleStyles.height) / 2}px`; // set the top and left for each drag handle
  ...
  addBox = cursor => {
    ...
    const box = document.createElement('div'); // Star with the specified styles

    Object.assign(box.style, this.options.handleStyles);
    box.style.cursor = cursor; // Set the width/height to use 'px'

    box.style.width = `${this.options.handleStyles.width}px`;
    box.style.height = `${this.options.handleStyles.height}px`; // listen for mousedown on each box

    box.addEventListener('mousedown', this.handleMousedown, false); // add drag handle to document

    this.overlay.appendChild(box); // keep track of drag handle

    this.boxes.push(box);
  };
  handleMousedown = evt => {
    // note which box
    this.dragBox = evt.target; // note starting mousedown position

    this.dragStartX = evt.clientX; // store the width before the drag

    this.preDragWidth = this.img.width || this.img.naturalWidth; // set the proper cursor everywhere

    this.setCursor(this.dragBox.style.cursor); // listen for movement and mouseup
  ...
  handleMouseup = () => {
    ...
    this.setCursor(''); // stop listening for movement and mouseup
...
;// CONCATENATED MODULE: ./src/ImageResize.js
...
class ImageResize {
  constructor(quill, options = {}) {
    ...
    this.options = defaultsDeep_default()({}, options, DefaultOptions); // (see above about moduleClasses)
  ...
  showOverlay = () => {
    ...
    this.quill.setSelection(null); // prevent spurious text selection

    this.setUserSelect('none'); // listen for the image being deleted or moved

    document.addEventListener('keyup', this.checkImage, true);
    this.quill.root.addEventListener('input', this.checkImage, true); // Create and add the overlay
  ...
  hideOverlay = () => {
    ...
    this.overlay = undefined; // stop listening for image deletion or movement

    document.removeEventListener('keyup', this.checkImage);
    this.quill.root.removeEventListener('input', this.checkImage); // reset user-select
  ...
  checkImage = evt => {
    if (this.img) {
      if (evt.keyCode == 46 || evt.keyCode == 8) {
        (window.Quill || (quill_default())).find(this.img).deleteAt(0);
      }
...
if (window.Quill) {
  ...
  window.Quill.register(ImageFormat, true); //END allow image alignment styles
